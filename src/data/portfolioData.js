...
export const portfolioData = {
    ...
    trustedCompanies: {
        ...
        logos: [
            ...
            { id: "logo-5", name: "Microsoft", image: "/images/Logo/microsoft.webp" },
            { id: "logo-6", name: "NUS", image: "/images/Logo/nus.webp" },
            ...
            { id: "logo-10", name: "Instead", image: "/images/Logo/instead.webp" }
        ]
    },
    workProjects: [
        saasMetrics,
    ...
    shots: [
        ...
        { id: "s6", title: "MacBook Air Concept", image: "/images/Shots/macbook_air.webp", published: true },
        { id: "s7", title: "Adaapt Dashboard", image: "/images/Shots/adaapt.webp", published: true },
        { id: "s8", title: "Digital Agency", image: "/images/Shots/digencial.webp", published: true },
        { id: "s9", title: "FitnessX App", image: "/images/Shots/fitnessx.webp", published: true },
        { id: "s10", title: "Ghumantu Travel", image: "/images/Shots/ghumantu.webp", published: true },
        { id: "s11", title: "Growzilla Brand", image: "/images/Shots/growzilla.webp", published: true },
        { id: "s12", title: "Nike Concept", image: "/images/Shots/nike.webp", published: true },
        { id: "s13", title: "Portfolio 2024", image: "/images/Shots/portfolio.webp", published: true },
        ...
        { id: "s16", title: "Poster Design", image: "/images/Shots/Poster.webp", published: true },
        { id: "s17", title: "Hustler X Icons", image: "/images/Shots/hustler_x_icons.webp", published: true },
        { id: "s18", title: "HustlerX Platform", image: "/images/Shots/hustlerx.webp", published: true },
        { id: "s19", title: "HustlerX Logo", image: "/images/Shots/logo_hustlerx.webp", published: true },
        { id: "s20", title: "Ludo Game Design", image: "/images/Shots/ludo.webp", published: true },
        { id: "s21", title: "Pricing Plans", image: "/images/Shots/plans.webp", published: true },
        { id: "s22", title: "Supreme Concept", image: "/images/Shots/supreme.webp", published: true },
        { id: "s23", title: "Trell Agency", image: "/images/Shots/trell.webp", published: true },
        { id: "s24", title: "Kiyaray App", image: "/images/Shots/kiyaray.webp", published: true },
        { id: "s25", title: "Microscope View", image: "/images/Shots/microscope.webp", published: true }
    ],
    about: {
        paragraphs: [
    ...
    hobby: {
        ...
        photos: [
            { id: "h1", image: "/images/Capture/cyber.webp", rotation: -6, title: "Cyber" },
            { id: "h2", image: "/images/Capture/delhi_bus_stop.webp", rotation: 4, title: "Delhi Bus Stop" },
            { id: "h3", image: "/images/Capture/delhi_metro.webp", rotation: -3, title: "Delhi Metro" },
            { id: "h4", image: "/images/Capture/india_gate.webp", rotation: 5, title: "India Gate" },
            { id: "h5", image: "/images/Capture/night.webp", rotation: -2, title: "Night Walk" },
            { id: "h6", image: "/images/Capture/nitj.webp", rotation: 3, title: "NITJ Days" }
        ],
