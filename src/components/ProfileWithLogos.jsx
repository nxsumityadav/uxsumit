...
// HoverReveal Component for interactive text with image preview
const HoverReveal = ({ text, image, href, icon }) => {
  ...
  return (
    <>
      ...
      {isHovered && ReactDOM.createPortal(
        <motion.div
          className="hover-reveal-image-container"
          style={{
            position: 'fixed',
            left: mousePos.x + 20,
            top: mousePos.y + 20,
        ...
        >
          <img src={image} alt="Preview" className="hover-preview-img" />
        </motion.div>,
        document.body
      )}
    </>
      ...
      <div className="profile-card">
        ...
        <p className="bio">
          {(() => {
            ...
            const parts = bioText.split(/(Spreetail|Taiyari AI)/g);
            ...
            return parts.map((part, i) => {
              ...
              return <span key={i} className="bio-text">{part}</span>;
            });
          })()}
        </p>
      ...
      <style>{`
        ...
        * {
        ...
        .hover-reveal-image-container {
          width: 300px; /* Reduced from maybe larger size */
          height: auto;
          border-radius: 12px;
          overflow: hidden;
